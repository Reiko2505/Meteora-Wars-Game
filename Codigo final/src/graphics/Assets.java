...
public class Assets {
	...
	public static void init()
	{
		...
		speed = loadImage("/res/effects/fire18.png");

        blueLaser = loadImage("/res/lasers/laserBlue01.png");

		backgroundImage= loadImage("/res/others/brujita.png");
		...
		fontBig = loadFont("/res/fonts/MonsterFriendFore.otf", 25);
	
		fontMed = loadFont("/res/fonts/MonsterFriendFore.otf", 12);
		...
		//"SpaceMusic" es una pieza original, hecha por el aspirante a la carrera de músioa, Hector Song, quien se ofreció en realizarla para darle un toque único al videojuego
